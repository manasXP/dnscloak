// Objective-C API for talking to github.com/manasXP/dnscrypt-proxy/dnscrypt-proxy/ios Go package.
//   gobind -lang=objc github.com/manasXP/dnscrypt-proxy/dnscrypt-proxy/ios
//
